CLASS zcl_ey_as_eml DEFINITION
 PUBLIC
 FINAL
 CREATE PUBLIC .
 PUBLIC SECTION.
...
CLASS ZCL_EY_AS_EML IMPLEMENTATION.


 METHOD if_oo_adt_classrun~main.
   case lv_opr.
       when 'R'.
           READ ENTITIES OF Zey_as_TRAVEL
           ENTITY Travel
       ...
       when 'C'.
           data(lv_description) = 'Ash Rocks with RAP'.
           data(lv_agency) = '070116'.
           data(lv_customer) = '000697'.
           MODIFY ENTITIES OF Zey_as_TRAVEL
           ENTITY Travel
