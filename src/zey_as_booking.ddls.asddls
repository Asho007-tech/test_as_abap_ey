...
define view entity ZEY_AS_BOOKING as select from /dmo/booking_m
composition[0..*] of ZEY_AS_BOOKSUPPL as _BookingSupplement
association to parent ZEY_AS_TRAVEL as _Travel on
