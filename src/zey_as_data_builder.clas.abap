CLASS zey_as_data_builder DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZEY_AS_DATA_BUILDER IMPLEMENTATION.


  METHOD fill_master_data.
    data : lt_bp type table of zey_as_bpa,
           lt_prod type table of zey_as_product.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zey_as_bpa from table @lt_bp.
     insert zey_as_product from table @lt_prod.
  ENDMETHOD.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zey_as_dte_id,
           lt_so type table of zey_as_so_hdr,
           lt_so_i type table of zey_as_so_item.
    ...
    select * from zey_as_bpa into table @data(lt_bpa).
    select * from zey_as_product into table @data(lt_prod).
    ...
    insert zey_as_so_hdr from table @lt_so.
    insert zey_as_so_item from table @lt_so_i.

  ENDMETHOD.


  METHOD flush.
    delete from : zey_as_bpa, zey_as_product, zey_as_so_hdr, zey_as_so_item.
  ENDMETHOD.
